...
- 本官方 Repo 是唯讀參考，用來提供規則、Prompt、資料字典與範例；不要把它誤當成學員成品。
- 先分別說出「學員專案位置」與「官方參考位置」。若無法辨識學員專案，停止並請學員選擇正確資料夾。
- 不要把官方 Repo 複製覆蓋到學員專案，也不要覆蓋學員已修改的畫面、文字、功能或資料。
- 若學員沒有上週作品，先取得明確確認，才可複製官方範例建立新作品。
